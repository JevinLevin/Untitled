...
public class MachineTile : InteractableTile, ISaving
{

    [Header("Machine Objects")]
    ...
    {
        worldData.machineTiles.Add(capacity);
    }
    ...
    protected override void Update()
    {
        ...
        if (indicator.TileSelected(gameObject))
        {
            ...
            if (!inMenu && Input.GetMouseButtonDown(1))
            {
                upgradeUI.Activate();
                inMenu = true;
            }
